...
function RiCaseDetail({ id }: { id: string }) {
  const { data: me } = useMe();
  const { t } = useLocale();
    ...
    <AppShell me={me} title={t('caseDetail')}>
      {detailQuery.isLoading ? (
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <CaseDetailView detail={detailQuery.data} backHref="/ri" />
          <CaseTransitions detail={detailQuery.data} mode="ri" />
...
export default function RiCasePage({
  params,
}: {

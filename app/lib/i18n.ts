...
const en = {
  ...
  lifecycleStep3Title: 'Objection or demarcation',
  lifecycleStep3Body:
    'On the day: Yes opens the demarcation window; No reschedules. Objection with reason closes the case. After demarcation done, report PDF is due within 12 hours (OVERDUE alert if late).',
  lifecycleStep3Meta: 'On scheduled day',
  ...
  'action.demarcationNo': 'No — reschedule',
  ...
  reportFile: 'Demarcation report (PDF)',
  downloadNotice: 'Download notice',
  downloadReport: 'Download report',
  noNotice: 'No notice PDF',
  noReport: 'No report PDF',
  ...
  reportRequired: 'Report PDF is required',
...
const hi: Record<MessageKey, string> = {
  ...
  downloadTemplate: 'CSV टेम्पलेट',
  downloadTemplateXlsx: 'Excel टेम्पलेट',
  ...
  'action.demarcationNo': 'नहीं — पुनर्निर्धारण',
  ...
  reportFile: 'सीमांकन प्रतिवेदन (PDF)',
  downloadNotice: 'सूचना डाउनलोड',
  downloadReport: 'प्रतिवेदन डाउनलोड',
  noNotice: 'सूचना PDF नहीं',
  noReport: 'प्रतिवेदन PDF नहीं',
  ...
  reportRequired: 'प्रतिवेदन PDF आवश्यक',
